...
const File = ({ stateFile, setStateFile, govFileId }) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const response = await axios.get(API_GOV_FILE_GET + "id=" + govFileId + "&perm_token=" + userPermissionId)
    ...
    return (
        <>
            {
                (stateFile === true) && <div className="overflow-y-scroll fixed top-0 right-0 bottom-0 left-0 h-full w-full z-[1001] bg-[rgba(0,0,0,.45)]">
