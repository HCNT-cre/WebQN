...
const FormAddFile = ({ stateFormAddFile, setStateFormAddFile }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    await fetch(
      "https://641e04a5945125fff3db0a63.mockapi.io/file",
      requestOptions
    )
            ...
            <div className="w-[1000px] max-w-[calc(100vw-80px)] my-0 mx-auto bg-white">
              <div className="relative rounded-[2px] bg-white">
                <button
                  ...
                  className="text-[20px] absolute right-0 w-[40px] h-[40px] bg-[#2f54eb] top-0 text-white "
                >
                  x
                </button>
                ...
                <div className="p-[24px] text-[14px] ">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex justify-center">
                      <input
                        className="mr-[12px] h-[32px] w-[60px] rounded-[2px] text-white bg-[#2f54eb] cursor-pointer"
                        type="submit"
                        value="Lưu"
                      />
                      <button
                        ...
                        className="h-[32px] w-[60px] border-[#2f54eb] border-solid border-[1px] rounded-[2px]"
                      >
                        Đóng
                      </button>
                    </div>
