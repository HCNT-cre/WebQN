...
const Header = ({ sideBarWidth, setSideBarWidth }) => {
    ...
    return (
        <>
            <div className={`z-50 flex justify-between px-[16px] transition-all ${sideBarWidth === 250 ? "ml-[260px] w-[calc(99%-255px)]" : "ml-[90px] w-[calc(99%-85px)]"} h-[75px]  mt-[8px] border-[2px] border-blue-700 rounded-md bg-blue-300 top-0`}>
